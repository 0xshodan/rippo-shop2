...
function ISDEKWidjet(params) {
  ...
  widjet.sdekWidgetEvents = function () {
    ...
    ipjq(IDS.get("cdek_widget_cnt")).on(
      "keyup",
      ".CDEK-widget__panel-address-search",
      "input",
      function (event) {
    ...
    ipjq(IDS.get("cdek_widget_cnt")).on(
      "click",
      ".CDEK-widget__tag-postamat",
      "p",
      function (event) {
        if (
          ipjq(IDS.get("cdek_widget_cnt"))
            .find(".CDEK-widget__tag-postamat")
            .hasClass("active")
        ) {
          widjet.sdekSetPVZS();
          ipjq(IDS.get("cdek_widget_cnt"))
    ...
    ipjq(IDS.get("cdek_widget_cnt")).on(
      "click",
      ".CDEK-widget__tag-cash",
      "p",
      function (event) {
        if (
          ipjq(IDS.get("cdek_widget_cnt"))
            .find(".CDEK-widget__tag-cash")
            .hasClass("active")
        ) {
          widjet.sdekSetPVZS();
          ipjq(IDS.get("cdek_widget_cnt"))
    ...
    ipjq(IDS.get("cdek_widget_cnt")).on(
      "click",
      ".CDEK-widget__tag-fitting-room",
      "p",
      function (event) {
        if (
          ipjq(IDS.get("cdek_widget_cnt"))
            .find(".CDEK-widget__tag-fitting-room")
            .hasClass("active")
        ) {
          widjet.sdekSetPVZS();
          ipjq(IDS.get("cdek_widget_cnt"))
